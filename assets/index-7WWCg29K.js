 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(x,L){var D=x.length;x.push(L);e:for(;0<D;){var se=D-1>>>1,he=x[se];if(0<i(he,L))x[se]=L,x[D]=he,D=se;else break e}}function n(x){return x.length===0?null:x[0]}function r(x){if(x.length===0)return null;var L=x[0],D=x.pop();if(D!==L){x[0]=D;e:for(var se=0,he=x.length,Hs=he>>>1;se<Hs;){var An=2*(se+1)-1,ca=x[An],Ln=An+1,Gs=x[Ln];if(0>i(ca,D))Ln<he&&0>i(Gs,ca)?(x[se]=Gs,x[Ln]=D,se=Ln):(x[se]=ca,x[An]=D,se=An);else if(Ln<he&&0>i(Gs,D))x[se]=Gs,x[Ln]=D,se=Ln;else break e}}return L}function i(x,L){var D=x.sortIndex-L.sortIndex;return D!==0?D:x.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],c=1,d=null,h=3,p=!1,v=!1,w=!1,C=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(x){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=x)r(u),L.sortIndex=L.expirationTime,e(a,L);else break;L=n(u)}}function E(x){if(w=!1,g(x),!v)if(n(a)!==null)v=!0,aa(T);else{var L=n(u);L!==null&&ua(E,L.startTime-x)}}function T(x,L){v=!1,w&&(w=!1,m(P),P=-1),p=!0;var D=h;try{for(g(L),d=n(a);d!==null&&(!(d.expirationTime>L)||x&&!tt());){var se=d.callback;if(typeof se=="function"){d.callback=null,h=d.priorityLevel;var he=se(d.expirationTime<=L);L=t.unstable_now(),typeof he=="function"?d.callback=he:d===n(a)&&r(a),g(L)}else r(a);d=n(a)}if(d!==null)var Hs=!0;else{var An=n(u);An!==null&&ua(E,An.startTime-L),Hs=!1}return Hs}finally{d=null,h=D,p=!1}}var k=!1,N=null,P=-1,Q=5,F=-1;function tt(){return!(t.unstable_now()-F<Q)}function gi(){if(N!==null){var x=t.unstable_now();F=x;var L=!0;try{L=N(!0,x)}finally{L?_i():(k=!1,N=null)}}else k=!1}var _i;if(typeof f=="function")_i=function(){f(gi)};else if(typeof MessageChannel<"u"){var Sh=new MessageChannel,R0=Sh.port2;Sh.port1.onmessage=gi,_i=function(){R0.postMessage(null)}}else _i=function(){C(gi,0)};function aa(x){N=x,k||(k=!0,_i())}function ua(x,L){P=C(function(){x(t.unstable_now())},L)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(x){x.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,aa(T))},t.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<x?Math.floor(1e3/x):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(x){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var D=h;h=L;try{return x()}finally{h=D}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(x,L){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var D=h;h=x;try{return L()}finally{h=D}},t.unstable_scheduleCallback=function(x,L,D){var se=t.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?se+D:se):D=se,x){case 1:var he=-1;break;case 2:he=250;break;case 5:he=1073741823;break;case 4:he=1e4;break;default:he=5e3}return he=D+he,x={id:c++,callback:L,priorityLevel:x,startTime:D,expirationTime:he,sortIndex:-1},D>se?(x.sortIndex=D,e(u,x),n(a)===null&&x===n(u)&&(w?(m(P),P=-1):w=!0,ua(E,D-se))):(x.sortIndex=he,e(a,x),v||p||(v=!0,aa(T))),x},t.unstable_shouldYield=tt,t.unstable_wrapCallback=function(x){var L=h;return function(){var D=h;h=L;try{return x.apply(this,arguments)}finally{h=D}}}})(gm);mm.exports=gm;var J0=mm.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XT(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function JT(t){const e=bi(Fi(t)).link,n=e?bi(Fi(e)).deep_link_id:null,r=bi(Fi(t)).deep_link_id;return(r?bi(Fi(r)).link:null)||r||n||e||t}class Fd{constructor(e){var n,r,i,s,o,l;const a=bi(Fi(e)),u=(n=a.apiKey)!==null&&n!==void 0?n:null,c=(r=a.oobCode)!==null&&r!==void 0?r:null,d=XT((i=a.mode)!==null&&i!==void 0?i:null);O(u&&c&&d,"argument-error"),this.apiKey=u,this.operation=d,this.code=c,this.continueUrl=(s=a.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=a.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=a.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=JT(e);try{return new Fd(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IN=Math.log(2);class TN{constructor(e){const n=s=>parseInt(Math.log(s)/IN,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const gl=function(t,e,n,r){t.sort(e);const i=function(a,u){const c=u-a;let d,h;if(c===0)return null;if(c===1)return d=t[a],h=n?n(d):d,new me(h,d.node,me.BLACK,null,null);{const p=parseInt(c/2,10)+a,v=i(a,p),w=i(p+1,u);return d=t[p],h=n?n(d):d,new me(h,d.node,me.BLACK,v,w)}},s=function(a){let u=null,c=null,d=t.length;const h=function(v,w){const C=d-v,m=d;d-=v;const f=i(C+1,m),g=t[C],E=n?n(g):g;p(new me(E,g.node,w,null,f))},p=function(v){u?(u.left=v,u=v):(c=v,u=v)};for(let v=0;v<a.count;++v){const w=a.nextBitIsOne(),C=Math.pow(2,a.count-(v+1));w?h(C,me.BLACK):(h(C,me.BLACK),h(C,me.RED))}return c},o=new TN(t.length),l=s(o);return new be(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 * @license MIT
 */function Cc(){return Cc=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Cc.apply(this,arguments)}function TP(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function kP(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function NP(t,e){return t.button===0&&(!e||e==="_self")&&!kP(t)}const RP=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],xP="startTransition",em=H0[xP];function PP(t){let{basename:e,children:n,future:r,window:i}=t,s=y.useRef();s.current==null&&(s.current=Ox({window:i,v5Compat:!0}));let o=s.current,[l,a]=y.useState({action:o.action,location:o.location}),{v7_startTransition:u}=r||{},c=y.useCallback(d=>{u&&em?em(()=>a(d)):a(d)},[a,u]);return y.useLayoutEffect(()=>o.listen(c),[o,c]),y.createElement(SP,{basename:e,children:n,location:l.location,navigationType:l.action,navigator:o,future:r})}const OP=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",AP=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ur=y.forwardRef(function(e,n){let{onClick:r,relative:i,reloadDocument:s,replace:o,state:l,target:a,to:u,preventScrollReset:c,unstable_viewTransition:d}=e,h=TP(e,RP),{basename:p}=y.useContext(On),v,w=!1;if(typeof u=="string"&&AP.test(u)&&(v=u,OP))try{let g=new URL(window.location.href),E=u.startsWith("//")?new URL(g.protocol+u):new URL(u),T=yh(E.pathname,p);E.origin===g.origin&&T!=null?u=T+E.search+E.hash:w=!0}catch{}let C=iP(u,{relative:i}),m=LP(u,{replace:o,state:l,target:a,preventScrollReset:c,relative:i,unstable_viewTransition:d});function f(g){r&&r(g),g.defaultPrevented||m(g)}return y.createElement("a",Cc({},h,{href:v||C,onClick:w||s?r:f,ref:n,target:a}))});var tm;(function(t){t.UseScrollRestoration="useScrollRestoration",t.UseSubmit="useSubmit",t.UseSubmitFetcher="useSubmitFetcher",t.UseFetcher="useFetcher",t.useViewTransitionState="useViewTransitionState"})(tm||(tm={}));var nm;(function(t){t.UseFetcher="useFetcher",t.UseFetchers="useFetchers",t.UseScrollRestoration="useScrollRestoration"})(nm||(nm={}));function LP(t,e){let{target:n,replace:r,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l}=e===void 0?{}:e,a=Vs(),u=mi(),c=T0(t,{relative:o});return y.useCallback(d=>{if(NP(d,n)){d.preventDefault();let h=r!==void 0?r:Nl(u)===Nl(c);a(t,{replace:h,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l})}},[u,a,c,r,i,n,t,s,o,l])}function DP(){const t=y.useRef(),e=y.useRef(),n=y.useRef(),{signup:r}=fr(),[i,s]=y.useState(""),[o,l]=y.useState(!1),a=Vs();async function u(c){if(c.preventDefault(),e.current.value!==n.current.value)return s("Passwords do not match");try{s(""),l(!0),await r(t.current.value,e.current.value),a("/")}catch(d){console.log("Failed to create an account:",d),s("Failed to create an account")}l(!1)}return _.jsx(_.Fragment,{children:_.jsx(q_,{className:"d-flex align-items-center justify-content-center",style:{minHeight:"100vh"},children:_.jsxs("div",{className:"w-100",style:{maxWidth:"400px"},children:[_.jsx(Xr,{className:"auth-card",children:_.jsxs(Xr.Body,{children:[_.jsx("h2",{className:"text-center mb-4",children:"Sign Up"}),i&&_.jsx(tl,{variant:"danger",children:i}),_.jsxs(xe,{onSubmit:u,children:[_.jsxs(gn,{id:"email",children:[_.jsx(xe.Label,{children:"Email"}),_.jsx(xe.Control,{type:"email",ref:t,required:!0,autoComplete:"username email"})]}),_.jsxs(gn,{id:"password",children:[_.jsx(xe.Label,{children:"Password"}),_.jsx(xe.Control,{type:"password",ref:e,required:!0,autoComplete:"new-password"})]}),_.jsxs(gn,{id:"password-confirma",children:[_.jsx(xe.Label,{children:"Password Confirmation"}),_.jsx(xe.Control,{type:"password",ref:n,required:!0,autoComplete:"new-password"})]}),_.jsx(Ed,{disabled:o,type:"submit",className:"w-100 btn",children:"Sign Up"})]})]})}),_.jsxs("div",{className:"w-100 text-center mt-2",style:{color:"#dddd"},children:["Already have an account? ",_.jsx(ur,{to:"/login",children:_.jsx("u",{children:"Log In"})})]})]})})})}function MP(){const{logout:t}=fr(),[e,n]=y.useState(""),r=Vs(),i=async()=>{n("");try{await t(),r("/login")}catch{n("Failed to log out")}};return _.jsxs("header",{className:"header",children:[_.jsx("div",{className:"profile-section",children:_.jsx(ur,{to:"/profile",children:_.jsx("img",{src:"user_icon.png",alt:"User Profile",className:"profile-icon"})})}),_.jsx("div",{children:_.jsx(ur,{to:"/",children:_.jsx("img",{src:"app_logo.png",alt:"App Logo",className:"app-logo"})})}),_.jsx("div",{className:"logout-section",children:_.jsx("button",{onClick:i,children:"Logout"})})]})}const bP=()=>{const{currentUser:t}=fr(),[e,n]=y.useState([]),r=y.useRef(!0);y.useEffect(()=>{const c=Kp(qp,`/users/${t.uid}/splits`),d=h=>{const p=h.val();r.current&&n(p||[])};return vx(c,d),()=>{yx(c,"value",d),r.current=!1}},[t.uid]),y.useEffect(()=>{i()},[e,t.uid]),y.useEffect(()=>{const c=JSON.parse(localStorage.getItem("splits"))||[];n(c)},[]);const i=async()=>{const c=Kp(qp,`/users/${t.uid}/splits`);await gx(c,e),localStorage.setItem("splits",JSON.stringify(e))},s=async(c,d)=>{const h=e.map(p=>p.id===c?{...p,name:d}:p);n(h),await i()},o=async(c,d,h,p)=>{const v=e.map(w=>{if(w.id===c){const C=[...w.data];return C[d]={...C[d],[h]:p},{...w,data:C}}return w});n(v),await i()},l=c=>{const d=e.filter(h=>h.id!==c);n(d),i()},a=c=>{const d=e.map(h=>{if(h.id===c){const p=Array.isArray(h.data)?[...h.data,{}]:[{}];return{...h,data:p}}return h});n(d)},u=()=>{const c={id:e.length+1,name:`Split ${e.length+1}`,data:[{}]};n([...e,c]),i()};return _.jsxs("div",{className:"content-area-container",children:[e&&e.map(c=>_.jsxs("div",{className:"split-container",children:[_.jsxs("div",{className:"split-header",children:[_.jsx("input",{type:"text",value:c.name,onChange:d=>s(c.id,d.target.value),onBlur:()=>setTimeout(i,300),onKeyDown:d=>{d.key==="Enter"&&i()},className:"split-name-input"}),_.jsx("button",{id:"delete-split-btn",onClick:()=>l(c.id),children:"Delete"})]}),c.data&&Array.isArray(c.data)&&c.data.length>0&&_.jsxs("table",{className:"split-table",children:[_.jsx("thead",{children:_.jsxs("tr",{children:[_.jsx("th",{children:"Exercise"}),_.jsx("th",{children:"Weight"}),_.jsx("th",{children:"Reps"})]})}),_.jsx("tbody",{children:c&&c.data.map((d,h)=>_.jsxs("tr",{children:[_.jsx("td",{children:_.jsx("input",{type:"text",value:d.exerciseName||"",onChange:p=>o(c.id,h,"exerciseName",p.target.value),onBlur:()=>setTimeout(i,300),onKeyDown:p=>{p.key==="Enter"&&i()},className:"cell-input"})}),_.jsx("td",{children:_.jsx("input",{type:"text",value:d.weight||"",onChange:p=>o(c.id,h,"weight",p.target.value),onBlur:()=>setTimeout(i,300),onKeyDown:p=>{p.key==="Enter"&&i()},className:"cell-input"})}),_.jsx("td",{children:_.jsx("input",{type:"text",value:d.reps||"",onChange:p=>o(c.id,h,"reps",p.target.value),onBlur:i,onKeyPress:p=>{p.key==="Enter"&&i()},className:"cell-input"})}),_.jsx("td",{children:_.jsx("button",{id:"delete-ex-btn",onClick:()=>deleteExercise(c.id,h),children:"X"})})]},h))})]}),_.jsx("button",{className:"add-ex-btn",onClick:()=>a(c.id),children:"Add Exercise"}),_.jsx("hr",{})]},c.id)),_.jsx("button",{className:"add-split-btn",onClick:u,children:"Add Split"})]})};function FP(){return _.jsx("div",{children:_.jsx("footer",{className:"footer",children:_.jsx("p",{children:"© 2024 MyWorkout App. All rights reserved."})})})}function UP(){const{currentUser:t}=fr();return _.jsx("div",{children:_.jsxs("div",{className:"profile-page",children:[_.jsxs("div",{className:"profile-header",children:[_.jsx("img",{src:"avatar_placeholder.png",alt:"User Profile",className:"profile-avatar"}),_.jsxs("div",{className:"user-info",children:[_.jsx("h2",{children:"Name"})," ",_.jsx("p",{children:t&&t.email})]})]}),_.jsxs("div",{className:"additional-info",children:[_.jsx("h3",{children:"Additional Information"}),_.jsx("div",{children:"Gender:"}),_.jsx("div",{children:"Age:"})]})]})})}function rm(){const e=mi().pathname==="/profile";return _.jsxs("div",{className:"dashboard",children:[_.jsx(MP,{}),_.jsx("div",{className:"container",children:e?_.jsx(UP,{}):_.jsx(bP,{})}),_.jsx(FP,{})]})}function jP(){const t=y.useRef(),e=y.useRef(),{login:n}=fr(),[r,i]=y.useState(""),[s,o]=y.useState(!1),l=Vs();async function a(u){u.preventDefault();try{i(""),o(!0),await n(t.current.value,e.current.value),l("/")}catch(c){console.log("Failed to sign in",c),i("Failed to sign in")}o(!1)}return _.jsx(_.Fragment,{children:_.jsx(q_,{className:"d-flex align-items-center justify-content-center",style:{minHeight:"100vh"},children:_.jsxs("div",{className:"w-100",style:{maxWidth:"400px"},children:[_.jsx(Xr,{className:"auth-card",children:_.jsxs(Xr.Body,{children:[_.jsx("h2",{className:"text-center mb-4",children:"Log In"}),r&&_.jsx(tl,{variant:"danger",children:r}),_.jsxs(xe,{onSubmit:a,children:[_.jsxs(gn,{id:"email",children:[_.jsx(xe.Label,{children:"Email"}),_.jsx(xe.Control,{type:"email",ref:t,required:!0,autoComplete:"username email"})]}),_.jsxs(gn,{id:"password",children:[_.jsx(xe.Label,{children:"Password"}),_.jsx(xe.Control,{type:"password",ref:e,required:!0,autoComplete:"current-password"})]}),_.jsx(Ed,{disabled:s,type:"submit",className:"w-100 btn",children:"Log In"})]}),_.jsx("div",{className:"w-100 text-center mt-3",children:_.jsx(ur,{to:"/forgot-password",children:"Forgot Password"})})]})}),_.jsxs("div",{className:"w-100 text-center mt-2",style:{color:"#dddd"},children:["Need an account? ",_.jsx(ur,{to:"/signup",children:_.jsx("u",{children:"Sign Up"})})]})]})})})}function $P({}){const{currentUser:t}=fr();return _.jsx("div",{children:t?_.jsx(CP,{}):_.jsx(EP,{to:"/login"})})}function zP(){const t=y.useRef(),{resetPassword:e}=fr(),[n,r]=y.useState(""),[i,s]=y.useState(!1),[o,l]=y.useState("");async function a(u){u.preventDefault();try{l(""),r(""),s(!0),await e(t.current.value),l("Check your inbox for further instructions")}catch(c){console.log("Failed to sign in",c),r("Failed to reset password")}s(!1)}return _.jsxs(_.Fragment,{children:[_.jsx(Xr,{className:"auth-card",children:_.jsxs(Xr.Body,{children:[_.jsx("h2",{className:"text-center mb-4",children:"Password reset"}),n&&_.jsx(tl,{variant:"danger",children:n}),o&&_.jsx(tl,{variant:"success",children:o}),_.jsxs(xe,{onSubmit:a,children:[_.jsxs(gn,{id:"email",children:[_.jsx(xe.Label,{children:"Email"}),_.jsx(xe.Control,{type:"email",ref:t,required:!0,autoComplete:"username email"})]}),_.jsx(Ed,{disabled:i,type:"submit",className:"w-100 btn",children:"Reset Password"})]}),_.jsx("div",{className:"w-100 text-center mt-3",children:_.jsx(ur,{to:"/login",children:"Login"})})]})}),_.jsxs("div",{className:"w-100 text-center mt-2",children:["Need an account? ",_.jsx(ur,{to:"/signup",children:"Sign Up"})]})]})}const WP=()=>_.jsx(PP,{basename:"/myworkout-app/",children:_.jsx(Px,{children:_.jsxs(IP,{children:[_.jsxs(jn,{element:_.jsx($P,{}),children:[_.jsx(jn,{path:"/",element:_.jsx(rm,{}),exact:!0}),_.jsx(jn,{path:"/profile",element:_.jsx(rm,{})})]}),_.jsx(jn,{path:"/signup",element:_.jsx(DP,{})}),_.jsx(jn,{path:"/login",element:_.jsx(jP,{})}),_.jsx(jn,{path:"/forgot-password",element:_.jsx(zP,{})})]})})});Za.createRoot(document.getElementById("root")).render(_.jsx(WP,{}));
