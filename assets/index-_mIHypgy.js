 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(x,L){var D=x.length;x.push(L);e:for(;0<D;){var se=D-1>>>1,he=x[se];if(0<i(he,L))x[se]=L,x[D]=he,D=se;else break e}}function n(x){return x.length===0?null:x[0]}function r(x){if(x.length===0)return null;var L=x[0],D=x.pop();if(D!==L){x[0]=D;e:for(var se=0,he=x.length,Hs=he>>>1;se<Hs;){var An=2*(se+1)-1,ca=x[An],Ln=An+1,Gs=x[Ln];if(0>i(ca,D))Ln<he&&0>i(Gs,ca)?(x[se]=Gs,x[Ln]=D,se=Ln):(x[se]=ca,x[An]=D,se=An);else if(Ln<he&&0>i(Gs,D))x[se]=Gs,x[Ln]=D,se=Ln;else break e}}return L}function i(x,L){var D=x.sortIndex-L.sortIndex;return D!==0?D:x.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],d=1,c=null,h=3,m=!1,g=!1,w=!1,C=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(x){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=x)r(u),L.sortIndex=L.expirationTime,e(a,L);else break;L=n(u)}}function E(x){if(w=!1,_(x),!g)if(n(a)!==null)g=!0,aa(T);else{var L=n(u);L!==null&&ua(E,L.startTime-x)}}function T(x,L){g=!1,w&&(w=!1,p(P),P=-1),m=!0;var D=h;try{for(_(L),c=n(a);c!==null&&(!(c.expirationTime>L)||x&&!tt());){var se=c.callback;if(typeof se=="function"){c.callback=null,h=c.priorityLevel;var he=se(c.expirationTime<=L);L=t.unstable_now(),typeof he=="function"?c.callback=he:c===n(a)&&r(a),_(L)}else r(a);c=n(a)}if(c!==null)var Hs=!0;else{var An=n(u);An!==null&&ua(E,An.startTime-L),Hs=!1}return Hs}finally{c=null,h=D,m=!1}}var k=!1,N=null,P=-1,Q=5,F=-1;function tt(){return!(t.unstable_now()-F<Q)}function gi(){if(N!==null){var x=t.unstable_now();F=x;var L=!0;try{L=N(!0,x)}finally{L?_i():(k=!1,N=null)}}else k=!1}var _i;if(typeof f=="function")_i=function(){f(gi)};else if(typeof MessageChannel<"u"){var Sh=new MessageChannel,R0=Sh.port2;Sh.port1.onmessage=gi,_i=function(){R0.postMessage(null)}}else _i=function(){C(gi,0)};function aa(x){N=x,k||(k=!0,_i())}function ua(x,L){P=C(function(){x(t.unstable_now())},L)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(x){x.callback=null},t.unstable_continueExecution=function(){g||m||(g=!0,aa(T))},t.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<x?Math.floor(1e3/x):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(x){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var D=h;h=L;try{return x()}finally{h=D}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(x,L){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var D=h;h=x;try{return L()}finally{h=D}},t.unstable_scheduleCallback=function(x,L,D){var se=t.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?se+D:se):D=se,x){case 1:var he=-1;break;case 2:he=250;break;case 5:he=1073741823;break;case 4:he=1e4;break;default:he=5e3}return he=D+he,x={id:d++,callback:L,priorityLevel:x,startTime:D,expirationTime:he,sortIndex:-1},D>se?(x.sortIndex=D,e(u,x),n(a)===null&&x===n(u)&&(w?(p(P),P=-1):w=!0,ua(E,D-se))):(x.sortIndex=he,e(a,x),g||m||(g=!0,aa(T))),x},t.unstable_shouldYield=tt,t.unstable_wrapCallback=function(x){var L=h;return function(){var D=h;h=L;try{return x.apply(this,arguments)}finally{h=D}}}})(gm);mm.exports=gm;var J0=mm.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IN=Math.log(2);class TN{constructor(e){const n=s=>parseInt(Math.log(s)/IN,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const gl=function(t,e,n,r){t.sort(e);const i=function(a,u){const d=u-a;let c,h;if(d===0)return null;if(d===1)return c=t[a],h=n?n(c):c,new me(h,c.node,me.BLACK,null,null);{const m=parseInt(d/2,10)+a,g=i(a,m),w=i(m+1,u);return c=t[m],h=n?n(c):c,new me(h,c.node,me.BLACK,g,w)}},s=function(a){let u=null,d=null,c=t.length;const h=function(g,w){const C=c-g,p=c;c-=g;const f=i(C+1,p),_=t[C],E=n?n(_):_;m(new me(E,_.node,w,null,f))},m=function(g){u?(u.left=g,u=g):(d=g,u=g)};for(let g=0;g<a.count;++g){const w=a.nextBitIsOne(),C=Math.pow(2,a.count-(g+1));w?h(C,me.BLACK):(h(C,me.BLACK),h(C,me.RED))}return d},o=new TN(t.length),l=s(o);return new be(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
